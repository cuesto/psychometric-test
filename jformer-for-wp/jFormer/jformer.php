...
class JFormer {
    ...
    //edited
    function addJFormPage($jFormPage,$duration=null) {
    ...
    function getHtml() {
        ...
        $duration_timer =  new JFormElement('div', Array(
            'id'=>'duration_timer',
            'style' => 'visibility:hidden; position:absolute;',
        ));
        $duration_timer->insert($duration);
        $formElement->insert($duration_timer);
        ...
        $script->update('jQuery(document).ready(function () { ' . $this->id . 'Object = new JFormer(\'' . $this->id . '\', ' . json_encode($this->getOptions()) . '); });');
