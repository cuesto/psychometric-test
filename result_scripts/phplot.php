...
//Colors and styles       (all colors can be array (R,G,B) or named color)
    ...
    public $default_colors = array(array(192,26,118),array(0,0,0));   // The default colors for data and error bars
   
       /* public $default_colors = array('orange', 'YellowGreen', 'blue', 'red', 'DarkGreen', 'purple', 'peru',
